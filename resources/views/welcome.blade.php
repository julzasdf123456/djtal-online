...
<div class="relative flex items-top justify-center min-h-screen bg sm:items-center sm:pt-0">

    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
            <div class="card">
                <div class="card-header border-0">
                    <span class="card-title" style="margin-right: 30px;">
                        <img src="{{ URL::asset('imgs/logo.jpg') }}" alt="" style="width: 40px;">
                         <strong>{{ env('APP_NAME') }} | Online Hub</strong>
                    </span>
...
<script>
    $(document).keypress(function(event){
        ...
        if(keycode == '13'){
            var accountNo = $('#acct-no').val()

            if (jQuery.isEmptyObject(accountNo)) {
                Swal.fire({
                    icon : 'warning',
    ...
    function getAccount(acctNo) {
        ...
        $.ajax({
            ...
            success : function(res) {
                window.location.href = "{{ url('/client') }}/" + acctNo
            ...
            error : function(err) {
                Swal.fire({
                        ...
                        text : 'There seems to be a problem in connecting to DJTal Online Services. Please try again later.'
                    })
                $('#loader').addClass('gone')
            }
        })
